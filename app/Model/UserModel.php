...
class UserModel extends Model
{
    ...
    public function load(int $id, string $columns = "*")
    {
        ...
        return $load->fetchObject() ?? null;
    }

    public function find(string $email, string $columns = "*"): false|array|null
    {
        ...
        return $find->fetchObject() ?? null;
    }

    public function all(int $limit = 30, int $offset = 0, string $columns = "*"): false|array|null
    {
